...
<nav class="navbar navbar-default">
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			...
			<c:if test="${empty mvo}"> <!-- 로그인 하지 않은 경우  -->
			...
			<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="${contextPath}/memUpdateForm.do"><span class="glyphicon glyphicon glyphicon glyphicon-wrench"></span> 회원정보수정</a></li>
						...
						<label>${mvo.memName} 님 Welcome</label>
						</c:if>
			</ul>
			</c:if>
		</div>
